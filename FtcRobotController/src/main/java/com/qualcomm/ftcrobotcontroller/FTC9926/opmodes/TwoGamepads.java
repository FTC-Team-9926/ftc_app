...
public class TwoGamepads extends Telemetry9926 {
    ...
    public void start() {
        ...
        Aim_Curr_Location = (int) get_encoder_position();
        Aim_New_Location = Aim_Curr_Location;
 //       int Max_Location = Aim_Curr_Location ;
    }
...
//        Aim_New_Location = (int) Range.clip(Aim_New_Location, -350, 640);
